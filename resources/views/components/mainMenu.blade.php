...
<div class="grid-main-menu text-main-menu">
    ...
    <div class="grid-sub-menu">
        ...
        @role('admin')
            <div><a href="{{ route('appointment.index') }}"
                    class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">
                    Turnos</a>
            </div>
        @else
            <div><a href="{{ route('user.appointment.index') }}"
                    class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">
                    Turnos</a>
            </div>
        @endrole
        ...
        @if (!Auth::check() || !Auth::user()->hasRole('admin'))
            <div><a href="{{ route('lostDog.index') }}"
                    class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">
                    Perros perdidos</a>
            </div>
            
            <div><a href="{{ route('lostDog.foundIndex') }}"
                    class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">
                    Perros encontrados</a> 
            </div>
        @endif

        @if (!Auth::check() || !Auth::user()->hasRole('admin'))
            <div><a href="{{ route('adoption.index') }}"
                    class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">
        ...
        @if (Auth::check() && !Auth::user()->hasRole('admin'))
            <div><a href="{{ route('adoption.userdogs') }}"
                    class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">
                    Mis perros en adopción</a>
            </div>
        @endif
